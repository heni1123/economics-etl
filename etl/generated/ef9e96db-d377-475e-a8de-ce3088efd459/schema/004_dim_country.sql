...
CREATE INDEX idx_fact_economic_indicators_country_year ON public.fact_economic_indicators(country_code, year);
...
CREATE INDEX idx_fact_exchange_rates_base_target ON public.fact_exchange_rates(base_currency, target_currency);
