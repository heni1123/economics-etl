...
CREATE INDEX idx_fact_exchange_rates_rate_timestamp ON public.fact_exchange_rates(rate_timestamp DESC);
...
CREATE INDEX idx_dim_country_region ON public.dim_country(region);
CREATE INDEX idx_dim_country_subregion ON public.dim_country(subregion);