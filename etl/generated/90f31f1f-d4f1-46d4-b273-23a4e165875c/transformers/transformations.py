...
class DataTransformer:
    ...
    def _gdp_growth_yoy(self, record: Dict) -> Any:
        ...
        gdp_previous = record.get('gdp_usd_prev', 0)
        if gdp_previous > 0 and gdp_current is not None:
    ...
    def _population_growth_yoy(self, record: Dict) -> Any:
        ...
        population_previous = record.get('population_prev', 0)
        if population_previous > 0 and population_current is not None:
