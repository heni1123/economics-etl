...
CREATE INDEX idx_fact_economic_indicators_year ON public.fact_economic_indicators (year);
CREATE INDEX idx_fact_economic_indicators_load_timestamp ON public.fact_economic_indicators (load_timestamp DESC);
...
CREATE INDEX idx_fact_exchange_rates_base_currency ON public.fact_exchange_rates (base_currency);
CREATE INDEX idx_fact_exchange_rates_target_currency ON public.fact_exchange_rates (target_currency);
CREATE INDEX idx_fact_exchange_rates_rate_date ON public.fact_exchange_rates (rate_date);
CREATE INDEX idx_fact_exchange_rates_load_timestamp ON public.fact_exchange_rates (load_timestamp DESC);
...
CREATE INDEX idx_dim_country_country_code ON public.dim_country (country_code);
CREATE INDEX idx_dim_country_last_updated ON public.dim_country (last_updated DESC);