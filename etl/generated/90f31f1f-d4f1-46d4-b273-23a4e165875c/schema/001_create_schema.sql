...
CREATE INDEX idx_fact_economic_indicators_year ON public.fact_economic_indicators (year DESC);
...
CREATE INDEX idx_fact_exchange_rates_rate_date ON public.fact_exchange_rates (rate_date DESC);
